...
agent = Agent(
    ...
    base_url="https://anymind.onrender.com"  # Optional: defaults to http://localhost:8000
)

# Send a message to the agent
# The message is saved to chat history and memory is automatically updated
response = agent.chat("Take the decisions pasted from {idea.txt} and let me know.")
